...
im=np.loadtxt('/home/ana/collision_system_ws/src/distance/src/depth_people_array.out', delimiter=',')
...
#ilestem = os.path.splitext(os.path.basename(img_name))[0]
plt.savefig('interp.png', dpi=100)